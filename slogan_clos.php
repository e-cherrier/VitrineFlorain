...
?>
      ...
      <section id="accueil" class="main style2 right dark fullscreen">
        <div class="content box style1">
          <header>
	         <h2>Désolé le sondage est clos.</h2>
           <p>Nous sommes en train de compiler l'ensemble de vos propositions pour vous permettre de choisir le slogan en AG!</p>
           <p>Réservez dès à présent la date du 03 mars pour <b>notre assemblée générale!</b></p>
          </header>
      <footer>
	<ul class="style2">
