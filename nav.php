              ...
              <ul>
                <li><a href="index.php#monnaie">Une Monnaie locale citoyenne</a>
                      <ul>
                        ...
                        <li> <a href="http://www.monnaielocalenancy.fr/doc/adhesion.pdf">Télécharger le bulletin d'adhésion</a></li>
                        <li><a href="http://beta.monnaielocalenancy.fr/faq">FAQ</a></li>
                        <li> <a href="index.php#orga">Les groupes de travail</a></li>
                        <li><a href="fete.php">La Fete de Lancement</a></li>
                ...
                <li><a href="acteurs.php">Où les dépenser?</a>
                  <ul>
                    ...
                    <li> <a href="annuaire.php?type=Poche">l'annuaire de poche</a></li>
...
EOD;
	...
	function display_acteurs_nav() {
	    ...
	    <div  class="actions dark " >
               ...
               <a id="press_imprim" href="annuaire.php?type=Poche" class="button style2 icon first">Annuaire de Poche</a>
               <a id="press_annuaire" href="annuaire.php?type=Livret" class="button style2 icon first">Annuaire en Livret</a>
            </div>
EOD;
   	    print $p;
	}
